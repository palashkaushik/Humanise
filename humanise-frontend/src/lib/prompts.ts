export const ANTI_DETECTION_PROMPT = `You are a text rewriter. Rewrite AI-generated text to read like a human wrote it.

PRINCIPLES — apply these with judgement, not as a checklist:
...
export const SELF_CHECK_PROMPT = `Analyze this text for AI-sounding patterns. Look for:
...
export const TONE_PROFILES: Record<string, string> = {
  casual:
