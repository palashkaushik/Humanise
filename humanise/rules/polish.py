...
AI_VOCABULARY_SWAPS = {
    ...
    r"\bpivotal\b": "key",
    r"\bcomprehensive\b": "full",
    # GPTZero: Mechanical Precision / Sophisticated Clarity
    r"\bprioritizes?\b": "leans toward",
    r"\bprioritiz(e|ing)\b": "focus on",
    r"\bclarit(y|ies)\b": "being clear",
    r"\bspecificity\b": "the details",
    r"\bsophistication\b": "fancy-sounding",
    r"\bnuanced\b": "tricky",
    r"\bconvey\b": "get across",
    r"\bdetailed\b": "thorough",
    r"\btechnical\b": "tech",
    r"\badvanced\b": "fancy",
    r"\bprecise\b": "exact",
    r"\bprecisely\b": "exactly",
    r"\bimperative\b": "needed",
    r"\bessential\b": "must-have",
    r"\bcritical\b": "key",
    r"\bsubstantive\b": "real",
    r"\bmeticulous\b": "careful",
    r"\brigor(ous)?\b": "solid",
    r"\bfacilitat(e|ing|ed)\b": "help",
    r"\belucidate\b": "explain",
    r"\belaborat(e|ing|ed)\b": "go into",
    r"\bsynthesize\b": "pull together",
    r"\bpragmatic\b": "practical",
    r"\bcommensurate\b": "on par with",
    r"\butilitarian\b": "useful",
    # GPTZero: Rich Yet Shallow / Lacks Spontaneity
    r"\bspontaneity\b": "life",
    r"\bemotional\s+depth\b": "feeling",
    r"\bvaried\b": "different",
    r"\brich\b": "full",
    r"\blacks?\b": "missing",
